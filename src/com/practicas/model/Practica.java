...
public class Practica {
    ...
    public boolean estaActiva() {
        return EstadoPractica.ACTIVA.equals(this.estado);
    }
    ...
    public int getHorasReglamentarias() {
        return horasReglamentarias;
    }

    public void setHorasReglamentarias(int horasReglamentarias) {
